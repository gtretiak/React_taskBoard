...
const [search, setSearch] = useState("");
  ...
  const addTask = useCallback((title: string, status: TaskStatus, deadline: Date) => {
  ...
  return (
    <div>
      ...
      <label htmlFor="search" className="task-search"></label>
        <input type="text" id="search" value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search task..."
        />

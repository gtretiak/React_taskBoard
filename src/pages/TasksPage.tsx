...
function TasksPage() {
  const [tasks, setTasks] = useState<DraftTask[]>([]); // state contains an array of Task objects, initially empty

  function addTask(title: string, status: TaskStatus, deadline: Date) {
    ...
    setTasks([...tasks, newTask]); // ... is a spread operator, takes the contents of tasks, adds new Task and puts all them into a new array
  }
